...
使用示例:
  # 记录产出
  python3 .harness/scripts/artifacts.py --action record --id SIM_Foundation_001 \\
    --files database/migrations/xxx1.php database/migrations/xxx2.php

  # 清理产出（实际删除）
  python3 .harness/scripts/artifacts.py --action clean --id SIM_Foundation_001

  # 清理产出（预览）
  python3 .harness/scripts/artifacts.py --action clean --id SIM_Foundation_001 --dry-run

  # 列出所有产出
  python3 .harness/scripts/artifacts.py --action list

  # 查看特定任务的产出
  python3 .harness/scripts/artifacts.py --action list --id SIM_Foundation_001
